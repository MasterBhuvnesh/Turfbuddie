...
export default async function Home() {
  return (
    <>
      <div style={{
    backgroundImage: `url(/assets/stadium1.jpg)`,
    ...
    height: '100px', // Adjust as needed
        ...
        <main className="flex-1  flex items-center justify-center p-4 relative z-10">
          <div className=" max-w-5xl mx-auto text-center px-2 sm:px-4 lg:px-6">
            ...
            <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 sm:mb-4 md:mb-6 typing-animation">
              Welcome to <span className="text-white">Turfbuddie</span>
            </h1>
            <p className="text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl text-white">
